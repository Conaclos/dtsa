note
	description: "Summary description for {JSON_DTSA_PROJECT_TESTING_RESPONSE_CONVERTER}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"

class
	JSON_DTSA_PROJECT_TESTING_RESPONSE_CONVERTER
...
feature -- Conversion
	...
	from_json (j: like to_json): detachable DTSA_PROJECT_TESTING_RESPONSE
