...
/**
 * 
 * @description Exception for invalid parameter in a configuration file.
...
// Creation
	 ...
	 *            - directory path.
	 */
	public InvalidParameterException (String aLabel, String aKey) {
...
// Constant
	 ...
	 * User message.
	 */
	protected final static String message = "Parameter '%s' has a value ivalid in the configuration '%s'.";
